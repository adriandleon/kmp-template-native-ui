package com.adriandeleon.kmp.template.analytics.data

import com.adriandeleon.kmp.template.analytics.domain.AnalyticsProvider
import com.adriandeleon.kmp.template.analytics.domain.CommonAnalyticsEvent
import com.adriandeleon.kmp.template.analytics.domain.CustomAnalyticsEvent
    ...
    FunSpec({
        context("with one provider") {
            ...
            test("should track one event") {
                ...
                verify(mode = VerifyMode.exactly(1)) { mockProvider.track(event) }
            }
