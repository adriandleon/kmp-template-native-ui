package com.adriandeleon.kmp.template.logger.domain
 ...
 *
 * @see com.adriandeleon.kmp.template.logger.data.KermitLoggerImpl
 * @see com.adriandeleon.kmp.template.logger.data.ConfigCatLoggerImpl
 */
interface Logger {
